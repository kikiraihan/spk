...
function tampilPenjelasan(){
	//penjelasan
	$("#inputMatriks").append(
		"<p class='small alert alert-info col-md-6'>"+
...
function tampilInputMatriks(matriks, kriteria){
	...
	for(var i = 0; i < kriteria.length; i++){
		if (i==0) $("#inputMatriks #row-pertama").append("<div class='text-center d-inline col-2 col-md-1 form-control form-control-sm form-control-plaintext'></div>");
		$("#inputMatriks #row-pertama").append(
			"<div class='text-center d-inline col-2 col-md-1 form-control form-control-sm form-control-plaintext font-weight-bold' >"+kriteria[i]+"</div>"
		);
	}
	...
	for(var i = 0; i < matriks.length; i++) {
		...
		for(var z = 0; z < matriks[i].length; z++) {
			...
			$("#inputMatriks #row"+i).append(// tampil nilai matriks
				"<input class='text-center d-inline col-2 col-md-1 form-control' type='text' name='matriks["+i+"]["+z+"]' value='"+matriks[i][z]+"'/>"
				);
